...
set CLASSPATH=%APP_HOME%\lib\pidlimts-test-0.4-all.jar

@rem Execute pidlimts-test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PIDLIMTS_TEST_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%PIDLIMTS_TEST_EXIT_CONSOLE%" exit 1
exit /b 1
